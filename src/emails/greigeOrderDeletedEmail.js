...
const greigeOrderDeletedEmail = async ({
  recipientName,
  recipientEmail,
  orderNo,
  fabricName,
  ...
  const subject = `🗑️ Greige Order #${orderNo} Deleted – Jasmine Automate`;
  ...
  <div style="max-width:600px;margin:auto;border:1px solid #e0e0e0;border-radius:8px;font-family:'Segoe UI',Tahoma,Geneva,Verdana,sans-serif;background:#fefefe;color:#333;">
    <div style="background:#D32F2F;color:#fff;padding:20px 30px;border-radius:8px 8px 0 0;">
      <h2 style="margin:0;font-weight:600;">Jasmine Automate</h2>
      <p style="margin:5px 0 0;">Greige Order Deleted</p>
    </div>

    <div style="padding:30px;">
      <p style="font-size:16px;">Hi <strong>${recipientName}</strong>,</p>
      <p style="font-size:15px;">The following Greige order has been deleted from the system:</p>
      ...
      <p style="font-size:14px;">If this was not intended, please contact the operations team immediately.</p>
...
export default greigeOrderDeletedEmail;

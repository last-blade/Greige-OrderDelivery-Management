...
const unit3OrderPlacedEmail = async ({
  recipientName,
  recipientEmail,
  greigeOrderNo,
  fabricName,
  ...
  const subject = `📦 Unit 3 Order Created for Greige Order #${greigeOrderNo} – Jasmine Automate`;
  ...
  <div style="max-width:600px;margin:auto;border:1px solid #e0e0e0;border-radius:8px;font-family:'Segoe UI',Tahoma,Geneva,Verdana,sans-serif;background:#f9f9f9;color:#333;">
    <div style="background:#0047AB;color:#fff;padding:20px 30px;border-radius:8px 8px 0 0;">
      ...
      <p style="margin:5px 0 0;">Unit 3 Order Created</p>
    </div>

    <div style="padding:30px;">
      <p style="font-size:16px;">Hi <strong>${recipientName}</strong>,</p>
      <p style="font-size:15px;">A Unit 3 order has been successfully created for the following Greige order:</p>
      ...
      <p style="font-size:14px;">You can manage this Unit 3 order from your dashboard.</p>
...
export default unit3OrderPlacedEmail;
